...
class ConverterToStix:
    ...
    def create_infrastructure(
        ...
        stix_infrastructure = stix2.Infrastructure(
            ...
            name=name,
            description="Attacker infrastructure software",
    ...
    def create_vulnerability(
        ...
        external_ref = self.create_external_reference(
            ...
            url=f"https://vulncheck.com/browse/cve/{cve}",
        )
        stix_vulnerability = stix2.Vulnerability(
            ...
            object_marking_refs=[stix2.TLP_AMBER],
            custom_properties={
                "x_opencti_cvss_base_score": base_score,
                "x_opencti_cvss_base_severity": base_severity,
                "x_opencti_cvss_attack_vector": attack_vector,
    ...
    def create_software(self, name: str, vendor: str, cpe: str) -> stix2.Software:
        ...
        Examples:
            >>> create_software("Microsoft Windows", "Microsoft", "cpe:/o:microsoft:windows")
        """
